...
#SBATCH --output=slurm_eval_all.%j.out
...
nextflow run main_lps.nf \
    -name eval_lps_ALL_${random_chars} \
    --batch_dir "/mnt/ScratchProjects/dat_projects/lps_analysis/merged_batch_lps" \
